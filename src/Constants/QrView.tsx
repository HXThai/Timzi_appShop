...
import { dimension } from '@app/constants/Theme';

const defaultRectStyle = { height: dimension.height, width: dimension.width, borderWidth: 0, borderColor: '#000000', marginBottom: 0 };
...
export class QRScannerRectView extends Component {
  ...
  getScanImageWidth() {
    return this.innerRectStyle.width;
  }
    ...
    return (
      <View style={[styles.container, { bottom: 0 }]}>
        ...
        {/* <View style={[this.getBackgroundColor(), { flex: 1, alignItems: 'center' }]}>
          <Text style={this.innerHintTextStyle} numberOfLines={1}>{this.props.hintText||"21"}</Text>
        </View> */}
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        {/*绘制顶部标题栏组件*/}
        { renderHeaderView && <View style={[styles.topContainer]}>
          {/* {renderHeaderView()} */}
          </View>}
