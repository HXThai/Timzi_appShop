            ...
            <View style={{padding: 10}}>
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <TouchableOpacity
                  ...
                  <Text style={{fontSize: 15}}>Tra cứu lịch sử doanh thu</Text>
                  <MaterialIcons
                    name={'navigate-next'}
                    size={28}
                    color={Color.main}
                ...
                <TouchableOpacity
                  ...
                  <Text style={{fontSize: 15}}>Tra cứu lịch sử chiết khấu</Text>
                  <MaterialIcons
                    name={'navigate-next'}
                    size={28}
                    color={Color.main}
                      ...
                      <TouchableOpacity
                        ...
                        <View
                          ...
                          <View
                            ...
                            <Text style={{fontSize: 15}}>Tổng tiền trả: </Text>
                            <Text>{styles.dynamicSort(item.fee_money)} đ</Text>
                          </View>
